...
\newcommand{\VersioneG}{1.0.3}
\newcommand{\VersionePQ}{0.0.0}
\newcommand{\VersioneNP}{1.1.0}
\newcommand{\VersionePP}{1.0.5}
\newcommand{\VersioneAR}{0.0.0}
\newcommand{\VersioneSF}{1.0.5}
...
Lo scopo di questo progetto è sviluppare un framework volto alla costruzione di bolle interattive, per aggiungere funzionalità al programma di comunicazione Rocket.Chat™  (link a homepage).
